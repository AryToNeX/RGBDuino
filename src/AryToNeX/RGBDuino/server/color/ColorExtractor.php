...
namespace AryToNeX\RGBDuino\server\color;

/**
 * Class ColorExtractor
 * @package AryToNeX\RGBDuino\server\color
 */
class ColorExtractor{

	/** @var \AryToNeX\RGBDuino\server\color\Palette */
	protected $palette;
	...
	/**
	 * @param \AryToNeX\RGBDuino\server\color\Palette $palette
	 */
